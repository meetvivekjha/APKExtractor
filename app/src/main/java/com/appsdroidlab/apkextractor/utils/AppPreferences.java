package com.appsdroidlab.apkextractor.utils;
...
public class AppPreferences {
    ...
    public AppPreferences(Context context) {
        //get a shared preference instance that point to a default preference file name.
        //all activities in same app context can access it.
        //usually located at /data/data/com.package.name/shared_prefs/com.package.name_preferences.xml
        this.sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        this.editor = sharedPreferences.edit(); // Create a new Editor for these preferences, through which you can make modifications to the data in the preferences and atomically commit those changes back to the SharedPreferences object.
        this.context = context;
    }

    //for retriving a int value from preference. returns the reference value if it exist
