...
public class UtilsRoot {
    ...
    public static boolean isRooted() {
        int rootStatus = APKExtractorApplication.getAppPreferences().getRootStatus();
        boolean isRooted = false;
        if (rootStatus == ROOT_STATUS_NOT_CHECKED) {
            isRooted = isRootByBuildTag() || isRootedByFileSU() || isRootedByExecutingCommand();
            APKExtractorApplication.getAppPreferences().setRootStatus(isRooted ? ROOT_STATUS_ROOTED : ROOT_STATUS_NOT_ROOTED);
